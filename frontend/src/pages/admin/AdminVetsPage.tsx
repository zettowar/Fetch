...
// Same preset bboxes as parks; vet density usually matches population.
...
export default function AdminVetsPage() {
  ...
  const runImport = useMutation<ImportResponse, unknown, Bbox | null>({
    mutationFn: async (bbox) => {
      const res = await client.post('/admin/vets/import-osm', { bbox });
      return res.data;
    },
    onSuccess: (data) => {
      toast.success(
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-5">
        ...
        existing OSM rows are updated in place and user-submitted clinics are
        never touched.
      </p>
