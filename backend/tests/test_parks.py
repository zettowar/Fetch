...
@pytest.mark.asyncio
async def test_get_park(client: AsyncClient, auth_headers: dict):
...
@pytest.mark.asyncio
async def test_nearby_parks(client: AsyncClient, auth_headers: dict):
...
@pytest.mark.asyncio
async def test_create_review(client: AsyncClient, auth_headers: dict):
    create_res = await client.post("/api/v1/parks", json={
...
@pytest.mark.asyncio
async def test_checkin(client: AsyncClient, auth_headers: dict):
    create_res = await client.post("/api/v1/parks", json={
